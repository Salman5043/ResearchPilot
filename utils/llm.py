...
def get_llm() -> ChatGroq:
    """Create the Groq LLM client when it is actually needed."""
...
def invoke_llm(
    ...
    demand exceeds the TPM budget. Callers should keep prompts compact and
    pass a task-specific max_tokens value.
    """
    requested_tokens = max_tokens or DEFAULT_MAX_TOKENS

    # Create the client only when an actual LLM request is made.
    llm = get_llm()
